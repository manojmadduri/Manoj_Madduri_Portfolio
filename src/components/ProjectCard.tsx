...
const ProjectCard = ({ title, description, image, techStack, modalContent }: ProjectCardProps) => {
    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
          <div className="bg-background dark:bg-navy-light rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto animate-scale-in">
